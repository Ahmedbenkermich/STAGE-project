    ...
    <div class="sidebar">
        ...
        <div class="sidebar-content">
            <ul class="lists">
                ...
                <li class="list">
                    <a href="/home_caissier" class="nav-link">
                        <i class="bx bx-home-alt icon"></i>
                        <span class="link">Accueille</span>
                    </a>
                </li>
                <li class="list">
                    <a href="/caissier" class="nav-link">
                        <i class="bx bx-list-ul icon"></i>
                        <span class="link">Cheque</span>
                    </a>
                </li>
...
<?php /**PATH C:\Users\a7med\Desktop\Stage_Project\resources\views/components/layout-ca.blade.php ENDPATH**/ ?>